...
function Terminos({ show, handleClose }) {
  return (
    <>
      <Modal show={show} onHide={handleClose} dialogClassName="modal-lg">
        ...
        <Modal.Body style={{ margin: '10px' }}><b>DEFINICIONES</b><br/>
<b>“Dueño del animal doméstico”:</b> significa cualquier persona que busca, contacta y reserva “Servicios para mascotas”<br/>

<b>Proveedor de servicios:</b> cualquier persona que crea un Servicio de Cuidado de Mascotas.<br/>
<b>Mascota Invitada:</b> significa cualquier mascota doméstica y/u otra mascota con respecto a la cual un Dueño de Mascota está buscando y/o reserva Servicios de Cuidado de Mascotas.<br/>

<b>Perfil de Servicios:</b> es la página web pública donde el Proveedor de Servicios de Mascotas indica sus precios e información sobre los servicios que ofrece.<br/>
...
Utilizar el Servicio sólo de manera legal y únicamente para los fines previstos en estos Términos.
Es su obligación cumplir con todas las leyes internacionales, federales y estatales aplicables, incluyendo las leyes y regulaciones fiscales que se aplican a su actividad en el Servicio.
No proporcionar información falsa en su perfil, hacerse pasar por otra persona o entidad, o crear cuentas múltiples o duplicadas.
No utilizar el Servicio para organizar la prestación y compra de servicios con otro usuario, y luego completar las transacciones de esos servicios fuera del Servicio “Gudog”.
No acceder o utilizar el Servicio con fines competitivos o publicar spam o promover otros productos o servicios.
No utilizar el Servicio de ninguna manera que tenga por objeto perjudicar o enviar mensajes amenazantes o difamatorios a otros usuarios, o violar los derechos legales (por ejemplo, derechos de privacidad) de otros usos, que se determinarán a discreción exclusiva de “Gudog”.
No comportarse ni actuar de ninguna manera que pueda causar molestias o daños a los empleados de “Gudog”, se determinará a la sola discreción de “Gudog”.
No publicar comentarios sobre Proveedores de Servicios que no se basan en su experiencia personal, son intencionalmente inexactos o engañosos, o violar estos Términos.
Usted no tiene ningún derecho sobre cualquier parte del Servicio que no sea el derecho a utilizarlos de acuerdo con estas Condiciones de Servicio.
No utilizar ninguna herramienta para acceder, copiar, adquirir información, o monitorear el Servicio o cualquier parte o Contenido del mismo.
No abusar del Servicio introduciendo a sabiendas virus, troyanos, gusanos, bombas lógicas u otro material que dañaría al Servicio.
...
Es su única responsabilidad determinar si el uso del Servicio es apropiado para su mascota y seleccionar un Proveedor de Servicio. “Gudog”, no hace ninguna declaración o garantía con respecto a la calidad de los proveedores de servicios o sus residencias. “Gudog” no es parte de ningún acuerdo o transacción entre el Propietario de la Mascota y el Proveedor de Servicios y, por lo tanto, no puede verificar o autenticar ninguna reclamación hecha por un Proveedor de Servicios.
Usted debe asegurarse de que sus mascotas están bien de salud, que han sido vacunados y que se han tomado todas las precauciones para las pulgas y garrapatas, parásitos internos y otras enfermedades transmisibles.
Deberá proporcionar toda la información pertinente a los proveedores de servicios con respecto a sus mascotas, incluyendo pero no limitado a: problemas médicos, problemas de comportamiento, restricciones dietéticas, alergias u otras condiciones antes de que una reserva comience.
Debe permitir que el Proveedor de Servicios visite y/o inspeccione a sus mascotas.
Usted debe estar disponible para un “encuentro previo”, con su mascota y proveedor de servicios en todos los casos antes de que una reserva comience.
Debe asegurarse de que el proveedor de servicios recibe la información de contacto pertinente para ponerse en contacto con usted, un contacto alternativo que sería capaz de recoger a su mascota (s), y su veterinario(s) en caso de una situación de emergencia.
Usted acepta que si no recoge a su(s) mascota(s) después de una Reserva el Proveedor de Servicio puede, a su sola discreción, entregar a su(s) mascota(s) en un alojamiento alternativo, cuidado familiar, control animal o con otras autoridades policiales. Además, usted acepta reembolsar al Proveedor de Servicios todos los costes y gastos asociados con tales acciones.
Usted reconoce que “Gudog”, se reserva el derecho, a su sola discreción, de retirar a sus mascotas del cuidado de un proveedor de servicios si se considera necesario para la seguridad de una mascota, el proveedor de servicios o cualquier persona que viva con el proveedor de servicios.
Usted acepta que es el único responsable de pagar cualquier impuesto aplicable que surja como resultado de su uso del Servicio “Gudog”. Esto incluye, sin limitación, cualquier forma de impuesto sobre las ventas, IVA o impuesto sobre la renta sobre las tasas pagadas o recibidas por usted a través del Servicio “Gudog”.
...
Usted acepta que usted, y otros residentes en su residencia, voluntariamente están aceptando ofrecer Servicios de Cuidado de Mascotas.
Usted acepta proporcionar libre y voluntariamente toda la información necesaria para su Perfil de Servicios, incluyendo su nombre, dirección y experiencia de cuidado de mascotas, y usted reconoce que esta información se hará pública en su Perfil de Servicios.
Usted acepta que “Gudog” se reserva el derecho de rechazar una solicitud para convertirse en un proveedor de servicios si determinamos a nuestra sola discreción que el solicitante no es apropiado. No tenemos obligación de revelar el motivo de nuestra decisión de rechazar una solicitud.
Deberá solicitar toda la información pertinente a los Propietarios de Mascotas en relación con las Mascotas Invitadas, incluyendo pero no limitado a: problemas médicos, problemas de comportamiento, restricciones dietéticas, alergias u otras condiciones antes de que una Reserva comience.
Usted estará disponible para un “encuentro previo” con el propietario de la mascota y su(s) perro(s) en todos los casos antes de comenzar una reserva.
Usted acepta que debe mantener un registro que contenga una descripción de cualquier mascota recibida en su cuidado, fecha de llegada y salida, registros diarios de actividad durante los Servicios de Cuidado de Mascotas y el nombre y dirección del Dueño de la Mascota.
Usted está de acuerdo en que todos los Servicios de Cuidado de Mascotas deben ser suministrados utilizando una habilidad y cuidado razonables, particularmente en relación con el alojamiento, bienestar y control de enfermedades.
Usted acepta que debe mantener a todas las mascotas con correa en las zonas públicas.
Usted acepta seguir todas las medidas necesarias para garantizar que las mascotas tengan viajes seguros en transporte público o privado. Usted siempre cumplirá con las regulaciones legales locales para cada tipo de transporte y se asegurará de que la recogida y/ o la entrega se hace en la hora programada acordada entre usted y el propietario de la mascota.
Usted acepta mantener al Propietario de la Mascota regularmente actualizado en cuanto a la salud de las mascotas, y responder con rapidez a cualquier petición del Propietario de la Mascota durante una reserva.
Usted acepta que la primera y todas las futuras reservas realizadas con un Propietario de Mascotas introducido por “Gudog” se reservarán a través de la plataforma Gudog y que el incumplimiento de esta política dará lugar a la suspensión o terminación del Servicio.
Usted acepta conceder a ”Gudog” una licencia mundial perpetua, no exclusiva y totalmente pagada para utilizar, copiar, realizar, mostrar públicamente, reproducir, adaptar, modificar, transmitir, preparar obras derivadas de, y/o distribuirá su Contenido en relación con la prestación y/o promoción del Servicio “Gudog”, y para sub-licenciar estos derechos a terceros.
Usted acepta que es el único responsable de pagar cualquier impuesto aplicable que surja como resultado de su uso del Servicio “Gudog”. Esto incluye, sin limitación, cualquier forma de impuesto sobre las ventas, IVA o impuesto sobre la renta sobre las tasas pagadas o recibidas por usted a través del Servicio “Gudog”.
EMPLEO
...
El propietario de la mascota seleccionará un proveedor de servicios de la lista de registrados en el servicio “Gudog”.
Para enviar una solicitud de reserva a un Proveedor de Servicios, el Propietario de la Mascota deberá rellenar un formulario con detalles incluyendo su nombre, número de teléfono, código postal, datos de Mascotas Invitadas, el tipo de Servicio de Cuidado de Mascotas solicitado y la fecha(s) que desea que se realice.
Una reserva no será confirmada a menos que sea aceptada por el proveedor de servicios.
Una vez aceptada la reserva, el importe total de la misma se cargará inmediatamente a la tarjeta del propietario de la mascota. Esto también puede incluir una cuota de servicio a pagar a “Gudog”, y cuando lo requiera la ley, la cantidad cargada también incluirá los impuestos aplicables.
“Gudog” iniciará el pago a los proveedores de servicios el siguiente día hábil después de completar una reserva.
...
Si el propietario de una mascota cancela con más de 3 días de antelación a la fecha de inicio de la reserva, “Gudog” reembolsará el pago de la reserva al propietario de la mascota, a excepción de la comisión de servicio de “Gudog”.
Si el propietario de una mascota cancela con menos de 3 días de antelación a la fecha de inicio de la reserva, ”Gudog” reembolsará el pago de la reserva al propietario de la mascota, excluyendo la comisión de “Gudog” y el 50% del importe de la reserva correspondiente al cuidador.
Si un proveedor de servicios realiza una solicitud de cancelación antes o durante una reserva ”Gudog” reembolsará el pago de la reserva al propietario de la mascota, incluyendo la comisión de servicio “Gudog”. Los proveedores de servicios que cancelen repetidamente las reservas confirmadas pueden ser retirados temporal o permanentemente del servicio ”Gudog”.
Si “Gudog” determina, a nuestra discreción, que un Proveedor de Servicios no ha proporcionado los Servicios de Cuidado de Mascotas según lo acordado, se emitirá un reembolso total o parcial al Propietario de la Mascota.
“Gudog”, inicia pagos a proveedores de servicios el siguiente día hábil después de completar una reserva. Una vez que estas cantidades han sido desembolsadas, cualquier disputa de pago adicional es entre el Propietario de la Mascota y el Proveedor de Servicios, y “Gudog” no tiene ninguna obligación de mediar o facilitar cualquier resolución.
...
Una visita de emergencia a un veterinario.
El costo de la medicina y/o alguna cirugía derivada de un accidente..
